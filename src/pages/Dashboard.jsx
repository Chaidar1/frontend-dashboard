...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: "Barlow Twins",
      icon: Cpu,
      gradient: isDarkMode ? "from-orange-600 to-orange-500" : "from-orange-500 to-orange-600",
      description: "CSSL dengan redundancy reduction"
    }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className={themeClasses.textMuted}>Selamat datang di Dashboard Testing Klasifikasi Malware</p>
        </div>
        <button
          onClick={toggleTheme}
      ...
      <div className={`relative overflow-hidden rounded-2xl p-8 shadow-xl ${
        ...
        <div className="relative z-10 flex justify-between items-center">
          <div>
            ...
            <p className="text-blue-100">Selamat datang di Dashboard Testing Klasifikasi Malware</p>
      ...
      <div className="text-center py-4">
        <p className={`text-xs ${themeClasses.textMuted}`}>
          &copy; 2026 Malware Detection System • Barlow Twins • CSSL • Redundancy Reduction
        </p>
      </div>
    </div>
  );
